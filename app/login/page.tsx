    ...
    return (
        <div className="font-sans bg-[#f6f6f8] text-slate-900 min-h-screen relative overflow-hidden flex flex-col dark:bg-[#161121] dark:text-slate-100">
            ...
            <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
                <Suspense fallback={
                    <div className="w-full max-w-[440px] flex justify-center py-12">
                        <div className="w-8 h-8 rounded-full border-2 border-[#0B1E59] border-t-transparent animate-spin"></div>
                    </div>
                }>
                    <LoginForm />
                </Suspense>
